...
> [[CS Fundamentals/Networking/Load Balancing|Load Balancing]] and [[CS Fundamentals/Networking/API Gateway|API Gateway]] are both, technically, **specific applications of the reverse-proxy concept** — this chapter is the general idea underneath both, and exists specifically to draw the boundaries between all three precisely, since conflating them is one of the most common imprecisions in system design interviews.
...
| **Covered in depth** | This chapter | [[CS Fundamentals/Networking/Load Balancing\|Load Balancing]] | [[CS Fundamentals/Networking/API Gateway\|API Gateway]] |
...
> Functionally, yes — a CDN edge server receives client requests and either serves a cached response directly or forwards to origin on the client's behalf, exactly the reverse-proxy shape, specialized further for geographic distribution and caching. Worth naming this overlap explicitly if asked — see [[CS Fundamentals/Networking/CDN Internals|CDN Internals]].
...
---
*Related: [[CS Fundamentals/00 - Learning Path|CS Fundamentals Learning Path]] · [[CS Fundamentals/Networking/Load Balancing|Load Balancing]] · [[CS Fundamentals/Networking/API Gateway|API Gateway]] · [[CS Fundamentals/Networking/CDN Internals|CDN Internals]]*
